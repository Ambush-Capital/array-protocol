...
async function main() {
    ...
    const driftPublicKey = new web3_js_1.PublicKey("DftNc7gwihkEEwQRpu4bV89N18xpNEuBVg7YkhTZZhVo");
    await (0, sdk_1.initialize)({ env: "mainnet-beta" });
    ...
    const searchUser = new web3_js_1.PublicKey("7MFxSBVG4MMEuSoeV8KmJtP3JpomeVoxcQ6PuehFHvzY");
    const userStateAddress = new web3_js_1.PublicKey("7MFxSBVG4MMEuSoeV8KmJtP3JpomeVoxcQ6PuehFHvzY");
    const driftStateAddress = new web3_js_1.PublicKey("4CEikLe8mQ5hwFBKqZz324K6L989Yjesiehe2u5oTaXz");
    const driftUserAddress = new web3_js_1.PublicKey("8ro5CTt3R3T2sVQBz1gEwJJVCiVrNtmQ9q27xGHxDhFG");
    const driftUserStatsAddress = new web3_js_1.PublicKey("8Md8rzvEsf96qq86caquR41k5BKwEA7dYNQUbgG9CX6R");
    const driftSpotMarketVaultAddress = new web3_js_1.PublicKey("3xj5rdLoVW2rrPX9hUVjSLWMk7gvkgreXApW3kjPQPU7");
    // Fetch accounts
    ...
    try {
        ...
        // Fetch Drift User
        try {
            let accounts = await (0, sdk_1.fetchUserAccounts)(connection, driftClient.program, searchUser);
        ...
        try {
            ...
            if (spotMarketVaultData) {
                ...
                const relevantMarket = spotMarkets.find(market => market.vault.equals(driftSpotMarketVaultAddress));
                if (relevantMarket) {
...
async function findAllDriftProgramAccounts(connection, driftProgramId) {
    try {
        ...
        for (let i = 0; i < accounts.length; i++) {
            ...
            try {
                ...
                if (account.pubkey.equals(new web3_js_1.PublicKey("4CEikLe8mQ5hwFBKqZz324K6L989Yjesiehe2u5oTaXz"))) {
